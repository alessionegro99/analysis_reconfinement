...
plot(x = seq(1, length(G_0), length(G_0) %/% 500), y = G_0[seq(1, length(G_0), length(G_0) %/% 500)], xlab = "n_configs", ylab = "G_0", main = paste0("G_0, h = ", sprintf("%.6f", h_pre)), type = "l")
...
plot(x = seq(1, length(G_min), length(G_min) %/% 500), y = G_min[seq(1, length(G_min), length(G_min) %/% 500)], xlab = "n_configs", ylab = "G_min", main = paste0("G_min, h = ", sprintf("%.6f", h_pre)), type = "l")
...
plot(x = seq(1, length(ReL), length(ReL) %/% 500), y = ReL[seq(1, length(ReL), length(ReL) %/% 500)], xlab = "n_configs", ylab = "ReL", main = paste0("ReL, h = ", sprintf("%.6f", h_pre)), xlim = c(0, 10000), type = "l")
